...
import { FREELANCERS, ALL_SKILLS } from "@/data/mockData";
...
const INITIAL_PROJECTS = [
  {
    ...
    client: "DataFlow AI",
    created: "2025-04-12",
    team_members: [1, 6, 10, 20],
  },
  {
    id: 2,
    title: "Neo-Banking Dashboard",
    description:
      "Rebuild client-facing dashboard in React with full accessibility compliance.",
    required_skills: ["React", "UI/UX", "Figma", "JavaScript"],
    budget: 8500,
    deadline_days: 30,
    team_size: 2,
    status: "in_progress",
  ...
  },
  {
    ...
    description:
      "Migrate legacy infrastructure to Kubernetes + GitOps workflow on AWS.",
  ...
  },
  {
    ...
    description:
      "Build scalable ETL pipeline for analytics data warehouse using Airflow + dbt.",
  ...
  },
  {
    ...
    description:
      "Train and deploy Bayesian + neural fraud detection model for fintech client.",
    required_skills: ["ML", "Python", "Data Science", "Docker"],
    budget: 22000,
    deadline_days: 90,
    team_size: 3,
    status: "in_progress",
...
function ExpandedRow({ project }) {
  const members = FREELANCERS.filter((f) =>
    (project.team_members ?? []).includes(f.id),
  );
  return (
    <motion.div
