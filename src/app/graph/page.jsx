...
// ─── Hardcoded graph dataset ──────────────────────────────────────────────────
const GRAPH_DATA = {
  nodes: [
    // Freelancers (type: "freelancer")
    {
      id: "f1",
      label: "Aria Voss",
      type: "freelancer",
    ...
    // Skills (type: "skill")
    { id: "s_python", label: "Python", type: "skill", x: 0, y: 0 },
    { id: "s_react", label: "React", type: "skill", x: 0, y: 0 },
    { id: "s_ml", label: "ML", type: "skill", x: 0, y: 0 },
    { id: "s_devops", label: "DevOps", type: "skill", x: 0, y: 0 },
    { id: "s_docker", label: "Docker", type: "skill", x: 0, y: 0 },
    { id: "s_pg", label: "PostgreSQL", type: "skill", x: 0, y: 0 },
    { id: "s_uiux", label: "UI/UX", type: "skill", x: 0, y: 0 },
    { id: "s_figma", label: "Figma", type: "skill", x: 0, y: 0 },
    { id: "s_node", label: "Node.js", type: "skill", x: 0, y: 0 },
    { id: "s_fastapi", label: "FastAPI", type: "skill", x: 0, y: 0 },
    { id: "s_ds", label: "Data Science", type: "skill", x: 0, y: 0 },
    { id: "s_js", label: "JavaScript", type: "skill", x: 0, y: 0 },
    // Projects (type: "project")
    { id: "p1", label: "AI Platform v2", type: "project", x: 0, y: 0 },
    { id: "p2", label: "Neo-Banking UI", type: "project", x: 0, y: 0 },
    { id: "p3", label: "DevOps Migration", type: "project", x: 0, y: 0 },
    { id: "p4", label: "ETL Pipeline", type: "project", x: 0, y: 0 },
    { id: "p5", label: "Mobile API", type: "project", x: 0, y: 0 },
  ],
  edges: [
    // HAS_SKILL
    { source: "f1", target: "s_python", type: "HAS_SKILL" },
    { source: "f1", target: "s_ml", type: "HAS_SKILL" },
    { source: "f1", target: "s_ds", type: "HAS_SKILL" },
    { source: "f2", target: "s_react", type: "HAS_SKILL" },
    { source: "f2", target: "s_js", type: "HAS_SKILL" },
    { source: "f2", target: "s_uiux", type: "HAS_SKILL" },
    { source: "f3", target: "s_devops", type: "HAS_SKILL" },
    { source: "f3", target: "s_docker", type: "HAS_SKILL" },
    { source: "f3", target: "s_pg", type: "HAS_SKILL" },
    { source: "f4", target: "s_uiux", type: "HAS_SKILL" },
    { source: "f4", target: "s_figma", type: "HAS_SKILL" },
    { source: "f5", target: "s_fastapi", type: "HAS_SKILL" },
    { source: "f5", target: "s_node", type: "HAS_SKILL" },
    { source: "f6", target: "s_ml", type: "HAS_SKILL" },
    { source: "f6", target: "s_ds", type: "HAS_SKILL" },
    { source: "f13", target: "s_python", type: "HAS_SKILL" },
    { source: "f13", target: "s_ml", type: "HAS_SKILL" },
    { source: "f13", target: "s_react", type: "HAS_SKILL" },
    { source: "f14", target: "s_react", type: "HAS_SKILL" },
    { source: "f14", target: "s_node", type: "HAS_SKILL" },
    // RELATED_TO (skill relationships)
    { source: "s_python", target: "s_ml", type: "RELATED_TO" },
    { source: "s_python", target: "s_ds", type: "RELATED_TO" },
    { source: "s_react", target: "s_js", type: "RELATED_TO" },
    { source: "s_react", target: "s_uiux", type: "RELATED_TO" },
    { source: "s_devops", target: "s_docker", type: "RELATED_TO" },
    { source: "s_docker", target: "s_pg", type: "RELATED_TO" },
    { source: "s_uiux", target: "s_figma", type: "RELATED_TO" },
    { source: "s_node", target: "s_fastapi", type: "RELATED_TO" },
    { source: "s_ml", target: "s_ds", type: "RELATED_TO" },
    // WORKED_ON (freelancer → project)
    { source: "f1", target: "p1", type: "WORKED_ON" },
    { source: "f2", target: "p2", type: "WORKED_ON" },
    { source: "f3", target: "p3", type: "WORKED_ON" },
    { source: "f4", target: "p2", type: "WORKED_ON" },
    { source: "f5", target: "p5", type: "WORKED_ON" },
    { source: "f6", target: "p4", type: "WORKED_ON" },
    { source: "f13", target: "p1", type: "WORKED_ON" },
    { source: "f13", target: "p2", type: "WORKED_ON" },
    { source: "f14", target: "p1", type: "WORKED_ON" },
  ],
};
...
export default function GraphPage() {
  ...
  const visNodes = GRAPH_DATA.nodes.filter((n) => filters[n.type]);

  const visEdges = GRAPH_DATA.edges.filter((e) => {
    const sn = GRAPH_DATA.nodes.find((n) => n.id === e.source);
    const tn = GRAPH_DATA.nodes.find((n) => n.id === e.target);
  ...
  const fraudNodes = GRAPH_DATA.nodes
        ...
        <div className="flex items-center justify-between flex-shrink-0">
          <div>
            ...
            <p className="text-slate-500 text-xs font-mono mt-0.5">
              {visNodes.length} nodes · {visEdges.length} edges · Force-directed
              simulation
            </p>
          </div>
