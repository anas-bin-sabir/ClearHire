...
function SearchPageInner() {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(async () => {
      ...
      setSearchError("");
      try {
        const res = await searchFreelancers({
          query,
          skills: filters.skills,
          minRate: filters.minRate > 0 ? filters.minRate : undefined,
          maxRate: filters.maxRate < 250 ? filters.maxRate : undefined,
          minRating: filters.minRating > 0 ? filters.minRating : undefined,
          availableOnly: filters.availableOnly,
          maxFraud: filters.maxFraud,
        });
        if (!cancelled) {
          setApiResults(res.freelancers.map(enrichFreelancer));
    ...
    <AppLayout title="Talent Search">
      <div className="flex gap-6 relative min-h-0">
                ...
                <button
                  ...
                  style={
                    filters.skills.includes(s)
                      ...
                      : {
                          background: `rgba(var(--border-base), 0.04)`,
        ...
        <div className="flex-1 min-w-0 space-y-5">
          ...
          {/* Meta */}
          <div
            className="flex items-center justify-between text-[10px] font-mono uppercase tracking-widest"
            style={{ color: "var(--text-subtle)" }}
          >
            <span>
              {searchLoading
                ? "Searching..."
                : `${results.length} profiles matched`}
            </span>
          ...
          {explanation && !searchLoading && (
            <AIReasoningBox
              key={explanation.slice(0, 40)}
              text={explanation}
              speed={12}
              title="A* SEARCH INTELLIGENCE"
            />
          )}
            ...
            <>
              ...
              <motion.div
                ...
                style={{
                  ...
                  borderLeft: `1px solid rgba(var(--border-base), 0.08)`,
                }}
              >
                <div
                  className="flex items-center justify-between px-6 py-4 flex-shrink-0"
                  style={{
                    borderBottom: `1px solid rgba(var(--border-base), 0.06)`,
                  }}
                >
                  <span
                ...
                >
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div
                        className="flex flex-wrap gap-3 mt-1 text-[11px] font-mono"
                        style={{ color: "var(--text-subtle)" }}
                      >
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    >
                      ...
                      <div
                        ...
                        style={{ background: `rgba(var(--border-base), 0.06)` }}
                      >
                        <motion.div
                          initial={{ width: 0 }}
                          animate={{
                    ...
                    <div className="space-y-3">
                      ...
                      {selectedFreelancer.reviews.map((r: any, i: number) => (
                        <div
                          ...
                          style={{
                            background: `rgba(var(--border-base), 0.03)`,
                            border: `1px solid rgba(var(--border-base), 0.06)`,
                          }}
                        >
                          <div className="flex items-center justify-between">
                ...
                <div
                  ...
                  style={{
                    borderTop: `1px solid rgba(var(--border-base), 0.06)`,
                  }}
                >
                  <a
